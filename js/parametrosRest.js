...
let mensaje = saludo1.concat(", ", saludo2, "!"); // Concatena strings

console.log(mensaje);

let saludo3 = "Hola Mundo";

console.log(saludo3.toLowerCase()); // Transforma todos los caracteres a minusculas
console.log(saludo3.toUpperCase()); // Transforma todos los caracteres a mayusculas

let saludo4 = "      Hola mundo   ";

console.log(saludo4);
console.log(saludo4.trim()); // trim elimina espacios en blanco al principio y al final del string

let texto = "javascript";

console.log(texto.substring(0, 5)); // substring sustrae una parte de la cadena de texto. El primer parametro es en donde empieza a cortar, y el segundo parametro es cuantos caracteres retornar

let frase = "Hola como estas?";
let palabras = frase.split("o"); // split crea un array con los elementos de un string. El parametro indica en donde cortar cada elemento
...
let indice = mascotas.indexOf("Gato");
